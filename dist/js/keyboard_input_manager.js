...
var KeyboardInputManager = function () {
  function KeyboardInputManager() {
    _classCallCheck(this, KeyboardInputManager);
  ...
  _createClass(KeyboardInputManager, [{
    key: "on",
    ...
    key: "restart",
    value: function restart(event) {
      event.preventDefault();
      this.emit("restart");
    }
  }, {
    key: "keepPlaying",
    value: function keepPlaying(event) {
      event.preventDefault();
      this.emit("keepPlaying");
    }
  }, {
    key: "bindButtonPress",
    value: function bindButtonPress(selector, fn) {
